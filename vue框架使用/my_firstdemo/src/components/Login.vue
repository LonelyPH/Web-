<template>
  <div>
    <div id="show-login" @click="show = !show" v-if="!show">Show Login Form</div>
...
#hide-login {
  ...
  border-radius: 50%;
  text-align: center;
  background-color: rgba(170, 167, 167, 0.7);
  color: #000;
  position: absolute;
  top: 40px;
  right: 40px;
...
#show-login:hover {
  background-color: rgb(46, 235, 39);
}
